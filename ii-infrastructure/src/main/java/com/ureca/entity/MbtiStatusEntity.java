...
@Getter
@NoArgsConstructor
public class MbtiStatusEntity implements Serializable {
  ...
  @Builder
  public MbtiStatusEntity(
      Integer typeIE, Integer typeSN, Integer typeTF, Integer typePJ, ChildEntity childEntity) {
    this.typeIE = typeIE;
    this.typeSN = typeSN;
    this.typeTF = typeTF;
    this.typePJ = typePJ;
