...
public class FeetbackStatusTest {
  ...
  @Autowired FeedbackStatusRepository feedbackStatusRepository;

  @Test
  public void insertFeetback() throws Exception {
    FeedbackStatusEntity newFeetbackLike =
    ...
    FeedbackStatusEntity newFeetbackDisLike =
        FeedbackStatusEntity.builder()
            .childEntity(null)
            .bookEntity(null)
    ...
    FeedbackStatusEntity newFeetbackCanceled =
        FeedbackStatusEntity.builder()
            .childEntity(null)
            .bookEntity(null)
    ...
    try {
      FeedbackStatusEntity newFeetbackByNum =
          FeedbackStatusEntity.builder()
              .childEntity(null)
              .bookEntity(null)
